...
export default function ScheduleForm({oneTrip}){
    ...
    return(
      ...
      <h5 className="donateRow" style={{marginTop: "1rem", marginBottom: "1px", fontFamily: "CopperPlate"}}>Spots Available: {avSpots}</h5>
            <h5 className="donateRow" style={{marginTop: "1px", marginBottom: "1px", fontFamily: "CopperPlate"}}>Cost Per Person: ${oneTrip.cost_per_person}</h5>
        <h5 className="donateRow" style={{marginTop: "1px", marginBottom: "1px", fontFamily: "CopperPlate"}}>Estimated Total: ${((parseInt(spaces))*1) * oneTrip.cost_per_person}</h5>
