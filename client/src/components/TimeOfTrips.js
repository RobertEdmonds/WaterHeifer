export default function TimeOfTrips({startTime, endTime}){
    ...
    return(
        <>
        <h5 className="donateRow" style={{marginBottom: "1px", marginTop: "1rem", fontFamily: "CopperPlate"}}>Start Time</h5>
        ...
        <h5 className="donateRow" style={{marginBottom: "1px", marginTop: "1rem", fontFamily: "CopperPlate"}}>End Time</h5>
